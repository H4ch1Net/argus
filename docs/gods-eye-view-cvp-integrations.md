...
*Dual-use. Runs against authorized scope only. Plots onto the globe.*
...
*Dual-use, the core CVP category. Standalone alongside the visualization; runs against lab/authorized targets.*
...
*Mostly plain defensive work. This is `sentryd` territory and ties existing work into the project.*
...
*Passive, public-source. Asset-scoped, never people-scoped.*
...
*Inherently scoped and authorized. Zero ambiguity.*
...
*Passive by default; active only against your own scope.*
